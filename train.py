...
np.random.seed(10)
'''This function is used to train the model for super-resolution image synthesis.'''
'''better to use downscale_factor = 4, image_shape = (384,384,3) for better results.'''
downscale_factor = 4

image_shape = (384,384,3)


''' vgg_loss is used to calculate the perceptual loss which is used to calculate the loss between the high-resolution and the generated high-resolution images.'''
...
''' use python3 train.py -h to get the help for the arguments.'''

''' already trained model is available in the model folder. So, no need to train the model again. '''
''' model is trained for 1000 epochs with batch size of 64 and 1000 images. '''
